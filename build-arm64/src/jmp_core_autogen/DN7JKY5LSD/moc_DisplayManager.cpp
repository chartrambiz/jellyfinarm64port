...
static constexpr auto qt_meta_stringdata_ZN14DisplayManagerE = QtMocHelpers::stringData(
    "DisplayManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14DisplayManagerE[] = {
...
Q_CONSTINIT const QMetaObject DisplayManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14DisplayManagerE.offsetsAndSizes,
    qt_meta_data_ZN14DisplayManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14DisplayManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void *DisplayManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14DisplayManagerE.stringdata0))
