...
static constexpr auto qt_meta_stringdata_ZN19DisplayManagerDummyE = QtMocHelpers::stringData(
    "DisplayManagerDummy"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19DisplayManagerDummyE[] = {
...
Q_CONSTINIT const QMetaObject DisplayManagerDummy::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19DisplayManagerDummyE.offsetsAndSizes,
    qt_meta_data_ZN19DisplayManagerDummyE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19DisplayManagerDummyE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DisplayManagerDummy, std::true_type>
    >,
    nullptr
} };
...
void *DisplayManagerDummy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19DisplayManagerDummyE.stringdata0))
