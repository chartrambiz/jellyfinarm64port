...
namespace {
struct qt_meta_tag_ZN12ErrorMessageE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12ErrorMessageE = QtMocHelpers::stringData(
    "ErrorMessage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ErrorMessageE[] = {
...
Q_CONSTINIT const QMetaObject ErrorMessage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ErrorMessageE.offsetsAndSizes,
    qt_meta_data_ZN12ErrorMessageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ErrorMessageE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<ErrorMessage *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *ErrorMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ErrorMessageE.stringdata0))
