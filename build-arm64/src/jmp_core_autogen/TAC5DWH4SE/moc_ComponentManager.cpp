...
#include "../../../../src/core/ComponentManager.h"
...
static constexpr auto qt_meta_stringdata_ZN16ComponentManagerE = QtMocHelpers::stringData(
    "ComponentManager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16ComponentManagerE[] = {
...
Q_CONSTINIT const QMetaObject ComponentManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16ComponentManagerE.offsetsAndSizes,
    qt_meta_data_ZN16ComponentManagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16ComponentManagerE_t,
        // Q_OBJECT / Q_GADGET
...
void *ComponentManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16ComponentManagerE.stringdata0))
